...
function fm.gui.showLeftPane(player_index_or_name)
    ...
    topLeftFlow.add({type = "checkbox", name = "FactorioMaps_dayOnly", state = global.config.dayOnly, caption = {"label-day-only"}, tooltip = {"tooltip-day-only"}});
    topLeftFlow.add({type = "checkbox", name = "FactorioMaps_altInfo", state = global.config.altInfo, caption = {"label-alt-info"}, tooltip = {"tooltip-alt-info"}});
...
--    folderFlow.style.maximal_width = 250;
    ...
    folderFlow.add({type = "textfield", name = "FactorioMaps_folderName", text = global.config.folderName, tooltip = {"tooltip-folder-name"}});
...
function fm.gui.showRightPane(player_index_or_name)
    ...
    rightPane.add({type = "checkbox", name = "FactorioMaps_customSize", state = global.config.customSize, caption = {"label-custom-size"}, tooltip = {"tooltip-custom-size"}});
    ...
    local topLeftX = tbl.add({type = "textfield", name = "FactorioMaps_topLeftX", text = global.config.topLeftX, tooltip = {"tooltip-top-left-x"}});
    topLeftX.style.minimal_width = 50;
    topLeftX.style.maximal_width = 50;
    local topLeftY = tbl.add({type = "textfield", name = "FactorioMaps_topLeftY", text = global.config.topLeftY, tooltip = {"tooltip-top-left-y"}});
...
--    tbl.add({type = "sprite-button", name = "FactorioMaps_topLeftReturn", sprite = "FactorioMaps_return_sprite", style = "FactorioMaps_sprite_button", tooltip = {"tooltip-top-left-return"}});
    ...
    local bottomRightX = tbl.add({type = "textfield", name = "FactorioMaps_bottomRightX", text = global.config.bottomRightX, tooltip = {"tooltip-bottom-right-x"}});
    bottomRightX.style.minimal_width = 50;
    bottomRightX.style.maximal_width = 50;
    local bottomRightY = tbl.add({type = "textfield", name = "FactorioMaps_bottomRightY", text = global.config.bottomRightY, tooltip = {"tooltip-bottom-right-y"}});
...
--    tbl.add({type = "sprite-button", name = "FactorioMaps_bottomRightReturn", sprite = "FactorioMaps_return_sprite", style = "FactorioMaps_sprite_button", tooltip = {"tooltip-bottom-right-return"}});
    ...
    fm.gui.radio.mapQualitySelect(global.config.mapQuality);
    ...
    fm.gui.radio.extensionSelect(global.config.extension);
